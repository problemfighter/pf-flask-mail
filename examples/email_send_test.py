...
if __name__ == '__main__':
    ...
    send_email.compose(["hmtmcse.com@gmail.com"], "Attachment")
    ...
    send_email.compose(["hmtmcse.office@gmail.com", "hmtmcse.com@gmail.com"], "Test only Text Email")
    send_email.add_text_message("This is Text email from send email test")
    send_email.send(False)

    send_email.compose("hmtmcse.com@gmail.com", "Test with cc")
    send_email.add_text_message("CC Email Test")
    send_email.add_cc("hmtmcse.office@gmail.com")
    send_email.send(False)

    send_email.compose("hmtmcse.com@gmail.com", "Test with BCC")
    send_email.add_text_message("BCC Email Test")
    send_email.add_bcc("hmtmcse.office@gmail.com")
    send_email.send(False)

    send_email.compose(["hmtmcse.com@gmail.com"], "HTML Email Test")
    send_email.add_html_message("<h1>This is HTML Body </h1>")
    send_email.send(False)

    send_email.compose("hmtmcse.com@gmail.com", "Test only Text Email")
    send_email.add_text_message("This is Text email from send email test")
    send_email.send()
